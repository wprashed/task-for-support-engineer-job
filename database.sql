...
--
-- Host: localhost:8889
-- Generation Time: Apr 04, 2024 at 05:56 AM
...
(17, 1, 5615.20, '2017-11-09', 'Doris Oliver', '2992 Sycamore Fork Road Hopkins, MN 55343', 'cash', 'inactive', '2017-11-09'),
(26, 1, 2278.50, '2017-11-27', 'Janet Richardsons', '4799 Ryder Avenue Everett, WA 98210', 'credit', 'inactive', '2017-11-27'),
(27, 1, 1475.00, '2024-03-22', 'One', 'KJNkjsefs', 'credit', 'active', '2024-03-21'),
(28, 1, 1132.25, '2024-03-26', 'jbhjkbk', 'n,jnj', 'credit', 'inactive', '2024-03-22'),
(29, 1, 571.20, '2024-03-25', 'One', 'sfjkskfs', 'cash', 'active', '2024-03-25');
...
(81, 27, 14, 1, 250.00, 18.00),
(82, 27, 14, 4, 250.00, 18.00),
(83, 28, 15, 5, 125.00, 5.00),
(84, 28, 11, 5, 85.00, 12.00),
(85, 29, 11, 3, 85.00, 12.00),
(86, 29, 11, 3, 85.00, 12.00);
...
(1, 'john_smith@gmail.com', '$2y$10$rhXgcuqxup8.un6GzQm1gO5N2eI2/AIcPYGVITg3LEbW9.3LDIlHK', 'John', 'master', 'Active'),
(2, 'donahuber@gmail.com', '$2y$10$Ex.JTn6Cu7lCHgaJoCBVeu0qer0cFp2X1qTIpPg2qfIkkuj3LjjMK', '0', 'user', 'Active'),
(3, 'roy_hise@gmail.com', '$2y$10$XlyVI9an5B6rHW3SS9vQpesJssKJxzMQYPbSaR7dnpWjDI5fpxJSS', '0', 'user', 'Active'),
(4, 'peter_goad@gmail.com', '$2y$10$n1B.FdHNwufTkmzp/pNqc.EiwjB8quQ1tBCEC7nkaldI5pS.et04e', '0', 'user', 'Active'),
(5, 'sarah_thomas@gmail.com', '$2y$10$s57SErOPlgkIZf1lxzlX3.hMt8LSSKaYig5rusxghDm7LW8RtQc/W', '0', 'user', 'Active'),
(6, 'edna_william@gmail.com', '$2y$10$mfMXnH.TCmg5tlYRhqjxu.ILly8s9.qsLKOpyxgUl6h1fZt6x/B5C', '0', 'user', 'Active'),
(8, 'john_parks@gmail.com', '$2y$10$WtsZUxIIz/N4NoIW0Db.pu0VfLWcPs6TyQ8SkpVHLDLGhdNOfALC.', '0', 'user', 'Active'),
(10, 'peter_parker@gmail.com', '$2y$10$GoQvEZNTWEibo0FPK7h57eA5UsNkXfIdex1deGsW/CFIY8zqxyu2S', '0', 'user', 'Inactive'),
(11, 'rashedcse18@.com', '$2y$10$89MPuoGhFU8StnTkFzARCulxXjNQRlIYm1TMCTS0HfX7tC1eWxyZ6', '0', 'user', 'Active'),
(12, 'rashedcse18@gmail.com', '$2y$10$09eL3L21VPgnDOPPVUvXVeRLvp2oaPwz..pRV2PH7whXV6pN0ihfK', '0', 'user', 'Active');
...
--
ALTER TABLE `inventory_order`
  MODIFY `inventory_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `inventory_order_product`
--
ALTER TABLE `inventory_order_product`
  MODIFY `inventory_order_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
